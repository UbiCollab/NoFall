...
public class SimplePieChartActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        cur = db.getUserMedicationRiskData();
        cur.moveToFirst();
        medicationData = Integer.parseInt(cur.getString(0));
        cur.close();
        
        cur = db.getUserSurveyRiskData();
        cur.moveToFirst();
        surveyData = Integer.parseInt(cur.getString(0));
        cur.close();
        
        cur = db.getUserTestRiskData();
        cur.moveToFirst();
        testData = Integer.parseInt(cur.getString(0));
        cur.close();
        
        s1 = new Segment("Sensor Risk Data", sensorData);
        s2 = new Segment("Medication Risk Data", medicationData);
        s3 = new Segment("Survey Risk Data", surveyData);
        s4 = new Segment("Test Risk Data", testData);
